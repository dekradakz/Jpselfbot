...
cl.login(token="EpC91IuWDA2Gg2EjguU3.CjN6sVzNB8RO/SalZdIbqW.J0mnQGXawdFUT+D1WOTMTqoJMhOrKXhnJ69/MK3oKZE=")
cl.loginResult()

ki = LINETCR.LINE() #bot1
ki.login(token="EpOTwt0Hh4txySLBDzXc.n0lqxUhuxD/FKEN2qKK/xa.vh6ic44aN6FXlL3Dv9XtJob7IEeqPPff+3l8yNs5Gkc=")
ki.loginResult()

ki2 = LINETCR.LINE() #bot2
ki2.login(token="Ep1pVT8zCLgWV2Cmv2ze.C0Y1XfbZ0HLQ34/AjPEO3G.gWuvM9jPDYX9s7/IurY+S1GisIrl6LsR56w1o3IK8Ao=")
ki2.loginResult()

ki3 = LINETCR.LINE() #bot3
ki3.login(token="EptlDXZl8TDZPT2M3YM2.v5tyuSJgHJst54f4YuqvKG.5msWX2YLrvklyMPN+Wkwmh5lRGPZAx/A6YMeRnFbc9g=")
ki3.loginResult()

ki4 = LINETCR.LINE() #bot4
ki4.login(token="EpzLBeIvD86HLniUp9v9.aQqPA2iBmuW1/6HcDhrjYq.9ytIa+Y0VmdEtfvhXpL+VPDtqqNDGZ4l5au4sOUucGQ=")
ki4.loginResult()

ki5 = LINETCR.LINE() #bot5
ki5.login(token="Ep9t5PLvVHCa8WaoQgJ1.QV+7hPdd3Rf84LSyRjbOeq.Oo32KY5UA7jCmFT0Cme5BhIrP7NQEHrxubsZJsNPJy0=")
ki5.loginResult()
              ...
              if msg.from_ in admin:
                ...
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off bos...")
                else:
                    wait["timeline"] = True
                    if wait["lang"] == "JP":
